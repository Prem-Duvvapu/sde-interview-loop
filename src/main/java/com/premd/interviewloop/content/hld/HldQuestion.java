...
/**
 * One HLD question, loaded from {@code question-bank/hld/*.yaml}.
 *
 * <p>Deliberately independent of the DSA/LLD question classes even though the shape is
 * near-identical — PROJECT_PLAN.md §4 calls out Phases 2-5 as genuinely independent,
 * separate-package work by design, so each module's content stays free of a shared base
 * class that would recouple them.
 */
